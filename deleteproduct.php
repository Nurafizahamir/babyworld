...
<form action="deleteStock.php?id=<?php echo $result['prodID'];?>">
			 ...
			 <?php
				  ...
				  while($row = mysqli_fetch_array($query)){
					  Print'<tr>
						...
						<td><a href="deleteStock.php?prodID='.$row['prodID'].'" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">DELETE</a></td>
				</tr>';
				  }
				  ?>      
